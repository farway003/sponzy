  ...
  return (
    <>
      ...
      <img width="500" src="/img/bck.png" />
       ...
       Sponzy Pro ile kendi sunucunuzu yönetmeye ne dersiniz? Kendi özgür dünyanızı yaratın ve kendi çalma listenizi oluşturun, bu keyfi en iyi seslerle yaşayın. 
	  </p>
        <div className="animateHeader mt-10 flex flex-wrap items-center justify-center gap-x-4">
            ...
            <Link href={"https://discord.com/api/oauth2/authorize?client_id=1045056119220998255&permissions=8&scope=bot%20applications.commands"}>
              ...
              >
          <i class="fa-solid fa-robot"></i> Botu Davet Et
              </a>
            </Link>
...
Bota Oy Ver</a>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-y-12 lg:gap-y-0 lg:gap-x-12 py-24">
          <div className="col-span-4">
            <p className="text-white text-4xl font-bold" dangerouslySetInnerHTML={{ __html:"Sponzy Pro" }} />
            ...
            <a href="https://discord.com/api/oauth2/authorize?client_id=1045056119220998255&permissions=8&scope=bot%20applications.commands" className={"mt-10 flex items-center px-4 justify-center gap-x-2 shadow-lg shadow-amber-600/20 cursor-pointer rounded-xl py-4 font-medium bg-gradient-to-r from-amber-700 to-amber-500 hover:opacity-80 transition duration-200 text-white"}>
          ...
          <div className="col-span-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div>
                <div className="text-white">
                  ...
                  <p className="text-gray-500 line-clamp-4">Sponzy Pro, sunucunuza özel hızlı ve özelleştirilebilir ayarlarla size müzik keyfini doyasıya yaşatır..</p>
                </div>
              </div>
              <div>
                <div className="text-white">
