...
export default function Partners() {
    ...
    return (
      ...
      <img width="400" src="/img/bck4.png" />
            ...
            <a href="https://discord.gg/3cUvbhmrEA">
                    ...
                    <div className="flex flex-col justify-center text-white rounded">
                        <a href="https://discord.gg/Fy4WmSThRZ">
                            <div className="flex-1 gap-x-4 flex items-center bg-gradient-to-b from-neutral-900/80 to-neutral-900/20 p-3 rounded-full">
                            <img className="rounded-full h-32 w-32" src="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" />
                            <div>
